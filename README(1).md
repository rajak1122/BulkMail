...
🔗 **BulkMail:** https://bulk-mail-psi-wheat.vercel.app/
...
1. User enters the required email details.
2. Form fields are validated.
3. Recipient email addresses are checked using Regex.
4. Invalid inputs are rejected with validation feedback.
5. Valid email details are processed for bulk sending.
6. Email activity is stored in the database.
7. Users can view previous activity through the **History Page**.
